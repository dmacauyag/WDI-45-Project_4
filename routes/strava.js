...
stravaRouter.post('/segments', (req, res) => {
  ...
  console.log('req data sent:', req.body)
  strava.segments.explore({'access_token':'23c2e332af8d3fe34dadf3215ca46ab2c57c5752', 'bounds': req.body.boundary, 'activity_type': req.body.activityType, 'min_cat': req.body.minClimbCat, 'max_cat': req.body.maxClimbCat}, (err, payload, limits) => {
